...
public class ReportsController {
	...
	public String showOpenTopicsByCategoryReport(Model model) {
		...
		List<OpenTopicByCategory> findAllByCurrentMonth = this.openTopicByCategoryRepository.findAllByCurrentMonth();
		
		model.addAttribute("openTopics", findAllByCurrentMonth);		
